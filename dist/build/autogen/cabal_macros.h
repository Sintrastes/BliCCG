...
/* package HaskellCCG-0.1.0.0 */
#ifndef VERSION_HaskellCCG
#define VERSION_HaskellCCG "0.1.0.0"
#endif /* VERSION_HaskellCCG */
#ifndef MIN_VERSION_HaskellCCG
#define MIN_VERSION_HaskellCCG(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_HaskellCCG */
